...
public static partial class Op
{
    ...
    public static JustPressedOperation Input(StringName action)
    {
...
public static partial class Op
{
    ...
    public static NAnimationOperation AnimationBackwards(string animation, double customBlend = -1)
    {
        NAnimationOperation operation = Pools.Obtain<NAnimationOperation>();
        operation.Animation = animation;
        operation.CustomBlend = customBlend;
        operation.CustomSpeed = -1;
        operation.FromEnd = true;
        return operation;
    }
    ...
    public static NSignalOperation NodeSignal(StringName signal, params Variant[] args)
    {
